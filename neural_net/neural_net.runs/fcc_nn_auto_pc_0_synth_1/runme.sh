...
HD_PWD='/home/anubhav/workspace-2019/neural_net/neural_net.runs/fcc_nn_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fcc_nn_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fcc_nn_auto_pc_0.tcl
