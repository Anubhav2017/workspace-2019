...
HD_PWD='/home/anubhav/workspace-2019/backprop_fcc_nn/backprop_fcc_nn.runs/design_1_auto_us_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_us_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_us_5.tcl
