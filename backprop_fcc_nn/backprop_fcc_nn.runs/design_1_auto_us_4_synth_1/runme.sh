...
HD_PWD='/home/anubhav/workspace-2019/backprop_fcc_nn/backprop_fcc_nn.runs/design_1_auto_us_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_us_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_us_4.tcl
