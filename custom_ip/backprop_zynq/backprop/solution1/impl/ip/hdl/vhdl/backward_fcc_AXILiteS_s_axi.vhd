...
entity backward_fcc_AXILiteS_s_axi is
generic (
...
end entity backward_fcc_AXILiteS_s_axi;
...
architecture behave of backward_fcc_AXILiteS_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_XDIM_DATA_0 : INTEGER := 16#10#;
    constant ADDR_XDIM_CTRL   : INTEGER := 16#14#;
    constant ADDR_YDIM_DATA_0 : INTEGER := 16#18#;
    constant ADDR_YDIM_CTRL   : INTEGER := 16#1c#;
