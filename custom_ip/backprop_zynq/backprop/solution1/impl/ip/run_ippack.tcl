...
set Library     "hls"
set IPName      "backward_fcc"
set Version     "1.0"
set DisplayName "Backward_fcc"
set Revision    "2111082016"
...
set sdx_kernel_name "backward_fcc"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/anubhav/workspace-2019/backprop_zynq/backprop/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {backward_fcc_fmulbkb
...
## Variables
set Top "backward_fcc"
set TopNoPrefix "backward_fcc"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 xdim W 0x0 "Data signal of xdim" {{0 32 xdim W 0 "Bit 31 to 0 Data signal of xdim"}}} {0x18 ydim W 0x0 "Data signal of ydim" {{0 32 ydim W 0 "Bit 31 to 0 Data signal of ydim"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_x m_axi_w m_axi_y m_axi_b m_axi_dx m_axi_dy m_axi_db m_axi_dw"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_dx {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_dx"
        data_width "32"
        param_prefix "C_M_AXI_DX"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_dy {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_dy"
        data_width "32"
        param_prefix "C_M_AXI_DY"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_db {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_db"
        data_width "32"
        param_prefix "C_M_AXI_DB"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_dw {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_dw"
        data_width "32"
        param_prefix "C_M_AXI_DW"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
